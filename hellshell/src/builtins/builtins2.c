...
// move target node from one list to the other
...
// need to check for invalid var names and return an error
// also need to check the other list for existence of var
